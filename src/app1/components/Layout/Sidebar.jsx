...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  const menuItems = [
    { name: "Dashboard", icon: <FaHome className="h-6 w-6" />, path: "/app1/" },
    { name: "Users", icon: <FaUsers className="h-6 w-6" />, path: "/app1/users" },
    { name: "Products", icon: <FaBoxOpen className="h-6 w-6" />, path: "/app1/products" },
    { name: "Orders", icon: <FaClipboardList className="h-6 w-6" />, path: "/app1/orders" },
    { name: "Reviews", icon: <FaStar className="h-6 w-6" />, path: "/app1/reviews" },
  ];
...
//     { name: 'Orders', icon: <FaClipboardList className="h-6 w-6" />, path: '/app1/orders' },
//     { name: 'Reviews', icon: <FaStar className="h-6 w-6" />, path: '/app1/reviews' },
//     // { name: 'Theme Settings', icon: <FaEdit className="h-6 w-6" />, path: '/app1/theme' },
//   ];
